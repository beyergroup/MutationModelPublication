...
# Define tissues and chromosomes
...
process_tissue <- function(tissue) {
  ...
  for (part in 1:50) {
    file_path <- paste0(input_dir, "exomeMuts_part", part, "_", tissue, "_RFpredictions.RData")
  ...
  bw_file <- paste0(output_dir, tissue, "_exome_mutation_prob.bw")
